	...
	<div class="tab-content">
		<div class="tab-pane fade active in">
			<div class="row search-form-default">
				<div class="col-md-12">
					<form action="#" method="get" class="form-inline form-validation form-search-init form-biz-ass-monstat-ass-index-monprogress-index"
						data-grid-search=".grid-biz-ass-monstat-ass-index-monprogress-index">
						<div class="input-group">
							
	<%-- 		<div class="form-group">
                <s:select id="id_first_gridid" name="monprogressParamBO.firstGridid" cssClass="form-control input-medium" list="firstGrididMap"  onchange="AssIndexMonprogressIndex.changeFirstGridid();"
                 placeholder="请选择一级网格..."/>
            </div> --%>
            <div class="form-group">
                <%-- <s:select id="id_second_gridid" name="monprogressParamBO.secondGridids" cssClass="form-control input-medium" list="{}"  multiple="true" onchange="AssIndexMonprogressIndex.changeSecondGridid();"
                 placeholder="请选择二级网格..."/> --%>
...
<!--             <div class="form-group" id="id_que_statime_div">
			...
			<div class="row">
				<div class="col-md-12">
					<table class="grid-biz-ass-monstat-ass-index-monprogress-index"></table>
				</div>
			</div>
		</div>
	</div>
</div>
<script src="${base}/biz/ass/monstat/ass-index-monprogress-index.js" />
