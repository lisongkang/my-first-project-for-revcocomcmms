	...
	<div class="tab-content">
		<div class="tab-pane fade active in">
			<div class="row search-form-default">
				<div class="col-md-12">
					<form action="#" method="get" class="form-inline form-validation form-search-init form-biz-remind-biz-remind-warning-rule"
						data-grid-search=".grid-biz-remind-biz-remind-warning-rule">
			...
			<div class="row">
				<div class="col-md-12">
					<table class="grid-biz-remind-biz-remind-warning-rule"></table>
				</div>
			</div>
		</div>
	</div>
</div>
<script src="${base}/biz/remind/biz-remind-warning-rule.js" />
