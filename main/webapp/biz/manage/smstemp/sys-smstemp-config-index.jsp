...
<div class="tabbable tabbable-primary">
   ...
   <div class="tab-content">
        <div class="tab-pane fade active in">
			<div class="row search-form-default">
			   <div class="col-md-12">
					<form action="#" method="get"
						class="form-inline form-validation form-search-init from-sys-smstemp-config-index"
						data-grid-search=".grid-sys-smstemp-config-index">
			...
			<div class="row">
				<div class="col-md-12">
					<table class="grid-sys-smstemp-config-index"></table>
				</div>
			</div>
	    </div>
   </div>
</div>
<script src="${base}/biz/manage/smstemp/sys-smstemp-config-index.js"></script>
