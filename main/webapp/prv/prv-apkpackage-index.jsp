...
<div class="tabbable tabbable-primary">
	...
	<div class="tab-content">
		<div class="tab-pane fade active in">
			<div class="row search-form-default">
				<div class="col-md-12">
					<form action="#" method="get"
						...
						data-grid-search=".grid-biz-prv-apk-index">
						<div class="input-group">
							<div class="input-cont">
								<input type="text" name="search['CN_catalogname']"
			...
			<div class="row">
				<div class="col-md-12">
					<table class="grid-biz-prv-apk-index"></table>
				</div>
			</div>
		</div>
	</div>
</div>
<script src="${base}/prv/prv-apkpackage-index.js" />
