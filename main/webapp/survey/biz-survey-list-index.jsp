...
<div class="tabbable tabbable-primary" id="div-biz-survey-list-index">
	<ul class="nav nav-pills">
		<li class="active"><a class="tab-default" data-toggle="tab"
			href="#tab-auto">问卷列表</a></li>
	...
	<div class="tab-content">
		<div class="tab-pane fade active in">
			<div class="row search-form-default">
				<div class="col-md-12">
					<form action="#" method="get"
						...
						data-grid-search=".grid-survey-list-index">
						<div class="input-group">
							...
							<div class="form-group">
								<s:select id="id_status" name="bizSurveyListParamBo.status" 
									list="surveyStatusMap" placeholder="请选择状态" cssStyle="width:150px"/>
							</div>
							<div class="form-group">
								<s:select id="id_isreal" name="bizSurveyListParamBo.isrealName"
									list="realNameStutusMap" placeholder="是否实名制" cssStyle="width:150px" />
							</div>
			...
			<div class="row">
				<div class="col-md-12">
					<table class="grid-survey-list-index"></table>
				</div>
			</div>
		</div>
	</div>
</div>
<script src="${base}/survey/biz-survey-list-index.js" />
