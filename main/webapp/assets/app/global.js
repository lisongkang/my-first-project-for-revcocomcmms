    ...
    return {
        init: function() {
            ...
            $("#a-logout").click(function() {
                bootbox.confirm("确认注销登录吗？", function(g) {
                    if (g) {
                        window.location.href = "prv/signin!logout"
                    }
                })
            });
            ...
            $.address.change(function(g) {
                ...
                if (h.size() > 0) {
                    ...
                    if (g.value == "/" || g.value == "/dashboard") {
                        ...
                        m.append('<li><i class="fa fa-home"></i> <a href="javascript:;">Dashboard</a></li>')
                    } else {
                        if (g.value == "/lock") {
            ...
            $("#fileupload").fileupload({
                autoUpload: false,
                dataType: "json",
                url: WEB_ROOT + "/common/pubpost/attachment-file!uploadMulti"
            });
            var f = $("#fileupload");
            var c = null;
            ...
            jQuery("body").on("click", "tbody.select-table-checkbox", function(h) {
        ...
        findUserProfileParams: function(b) {
            if (a == undefined || a == null) {
                a = $("body").cacheData(WEB_ROOT + "/profile/simple-param-val!params.json")
            }
            return a[b]
        },
                ...
                if (e.length == 0) {
                    ...
                    if (j.size() > 0) {
                        ...
                        if (l.length > 0) {
                            ...
                            if (b != undefined && b.indexOf("bpm-task!show") > -1) {
