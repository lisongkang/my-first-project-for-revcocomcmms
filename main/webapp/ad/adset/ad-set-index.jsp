	...
	<div class="tab-content">
		<div class="tab-pane fade active in">
			<div class="row search-form-default">
				<div class="col-md-12">
					<form action="#" method="get" class="form-inline form-validation form-search-init form-ad-set-index"
						data-grid-search=".grid-ad-set-index">
			...
			<div class="row">
				<div class="col-md-12">
					<table class="grid-ad-set-index"></table>
				</div>
			</div>
		</div>
	</div>
...
<script src="${base}/ad/adset/ad-set-index.js"></script>
