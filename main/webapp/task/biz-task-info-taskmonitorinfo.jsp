...
<div class="div-task-info-taskmonitorinfo">
<form class="form-horizontal form-bordered form-label-stripped form-validation form-biz-task-info-taskmonitorinfo"
	...
	<div class="form-body">
        ...
        <div class="row">
            <div class="col-md-10">
				<div class="form-group">
					<label class="control-label">任务分配网格</label>
					<div class="controls">
		                <s:textfield id="id_taskdesc" name="model.gridname" required="true"  />
					</div>
				</div>
            </div>
        </div>
...
<script src="${base}/task/biz-task-info-taskmonitorinfo.js" />
