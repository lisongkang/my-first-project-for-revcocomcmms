	...
	<div class="tab-content">
		<div class="tab-pane fade active in">
			<div class="row search-form-default">
				<div class="col-md-12">
					<form action="#" method="get" class="form-inline form-search-init form-validation form_biz_task_info_index"
						data-grid-search=".grid_biz_task_info_index">
			...
			<div class="row">
				<div class="col-md-12">
					<table class="grid_biz_task_info_index"></table>
				</div>
			</div>
		</div>
	</div>
...
<script src="${base}/task/biz-task-info-index.js"></script>
