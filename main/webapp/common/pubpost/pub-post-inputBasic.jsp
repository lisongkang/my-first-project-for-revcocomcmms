...
<form class="form-horizontal form-bordered form-label-stripped form-validation" action="${base}/common/pubpost/pub-post!doSave"
	method="post">
	<s:hidden name="id" />
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<div class="controls">
						<s3:datetextfield name="expireTime" format="yyyy-MM-dd HH:mm:00" data-timepicker="true" required="true"/>
					</div>
				</div>
			</div>
		</div>
