...
public class SslRequest{
    ...
    public SslRequest() throws UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException, KeyStoreException, IOException {
        init();
    }
    ...
    private void init() throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
        ...
        try {
            keyStore.load(instream, "1220354901".toCharArray());//设置证书密码
		...
		SSLContext sslcontext = SSLContexts.custom()
                .loadKeyMaterial(keyStore, "1220354901".toCharArray())
                .build();
        @SuppressWarnings("deprecation")
