 ...
 */
public class QueMonPromResp implements Serializable {
    private List<PromMonReceDataInfo> dataInfoList;
    ...
    public List<PromMonReceDataInfo> getDataInfoList() {
        return dataInfoList;
    }

    public void setDataInfoList(List<PromMonReceDataInfo> dataInfoList) {
