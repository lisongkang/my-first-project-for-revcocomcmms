 ...
 */
public class QueMonReceDataResp implements Serializable {
    private List<SubMonReceDataInfo> dataInfoList;
    ...
    public List<SubMonReceDataInfo> getDataInfoList() {
        return dataInfoList;
    }

    public void setDataInfoList(List<SubMonReceDataInfo> dataInfoList) {
