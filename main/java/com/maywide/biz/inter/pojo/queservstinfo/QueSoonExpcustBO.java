...
public class QueSoonExpcustBO implements java.io.Serializable {
	...
	public String getPatchidname() {
		return patchidname;
	}
	public void setPatchidname(String patchidname) {
		this.patchidname = patchidname;
	}
