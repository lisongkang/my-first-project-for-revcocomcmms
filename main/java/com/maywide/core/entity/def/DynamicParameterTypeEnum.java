...
public enum DynamicParameterTypeEnum {
    ...
    @MetaData(value = "枚举数据定义", comments = "根据枚举对象的name()和getLabel()返回对应的key1-value1结构数据,对应的listDataSource写法示例：com.maywide.demo.po.entity.PurchaseOrder$PurchaseOrderTypEnum")
    ENUM,
