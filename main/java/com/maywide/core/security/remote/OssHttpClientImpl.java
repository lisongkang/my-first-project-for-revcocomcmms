...
public class OssHttpClientImpl {

	private static Logger log = LoggerFactory.getLogger(OssHttpClientImpl.class);
	 ...
	 * @throws Exception
	 */
	public static RemotecallLog requestPost(PostMethod postMethod,String requestContent) throws Exception {
		...
		copyReqInfo2callLog(postMethod, retRemotecallLog,requestContent);
	...
	private static void copyBaseRespInfo2callLog(String respJsonStr, RemotecallLog remotecallLog) {
		...
		try {
			...
			String code = jsonObject.optString("statusCode");
	...
	private static void copyReqInfo2callLog(PostMethod postMethod, RemotecallLog remotecallLog,String requestContent)
		...
		remotecallLog.setRequest(requestContent);
	}
