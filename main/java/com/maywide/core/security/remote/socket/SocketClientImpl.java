...
import com.maywide.core.socket.ClientHandler;
...
public class SocketClientImpl {
     ...
     * @param port
     * @param request
     * @param environmentEncodeing
     * @param cliendid
     * @return
     * @throws Exception 
     */
    public static RemotecallLog sockeSend(String _ip,int _port,
    		ServiceOrgRequest request,String environmentEncodeing
    		,String cliendid) throws Exception{
    	if (StringUtils.isBlank(environmentEncodeing)) {
            // Environment.UAP_ENCODING
            throw new Exception("编码格式不能为空");
        }
    	  // 1.转换请求对象为xml串
        String req = socketReq2CompactXml2(request, environmentEncodeing);
        ...
        retRemotecallLog.setClientcode(cliendid);
    ...
    public static RemotecallLog sockectSend(String _ip, int _port,
    ...
    private static String socketReq2CompactXml2(Object req, String encoding) throws Exception{
    	 CheckUtils.checkNull(req, "请求对象为空");

         XmlConverter converter = new XmlConverter();
         String retXml = converter.toCompactXML2(req);
      // header
    ...
    private static String socketReq2CompactXml(Object req, String encoding)
            throws Exception {
        CheckUtils.checkNull(req, "请求对象为空");
    ...
    // 将返回串的共公信息解析并保存到日志对象
    private static void copySocketBaseRespInfo2callLog(String responseStr,
    ...
    public static ServiceResponse socketResp2Respobj(String resp, Object output)
            throws Exception {
    ...
    public static String sendXML(String _ip, int _port, String request,
        ...
        try {
            ...
            byte[] response = socket.sendBytes(reqBytes);
    ...
    protected static byte[] appendBytes(byte[] data, byte[] bytes, int count) {
